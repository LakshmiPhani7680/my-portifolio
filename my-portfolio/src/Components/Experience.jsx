  ...
  const experiences = [
    {
      ...
      responsibilities: [
        "Integrating LLMs into enterprise tools.",
        "Developed Python-based FaaS modules for ENSO using GitLab CI/CD",
        "Used Azure Blob API to store and manage files.",
      ],
      tech: ["python", "numpy", "pandas","Gitlab"],
    },
    {
    ...
    },
    {
      ...
      tech: ["three-js", "amcharts4", "node-js"],
    },
    {
          ...
          <div className="p-6">
            <div className="code-block mb-8">
              ...
              <div className="mt-4">
                {experiences.map((exp, index) => (
                  <div
                    key={index}
                    className={`pl-4 mb-6 terminal-card transition-all duration-300 ${
                      expandedExp === index
                        ? "border-green-400"
                        : "border-gray-700"
                    }`}
                    ...
                    <div className="p-4 cursor-pointer">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                          ...
                          <span
                            className="ml-3 text-green-400 transform transition-transform duration-300"
                            style={{
                              transform:
                                expandedExp === index
                                  ? "rotate(180deg)"
                          ...
                          <div className="mb-4">
                            ...
                            <div className="pl-4 space-y-2 mt-2">
                              {exp.responsibilities.map((resp, i) => (
                                <div
                                  key={i}
                                  className="achievement-item flex items-start group"
                                >
                                  <span className="text-purple-400 mr-2 transform group-hover:translate-x-1 transition-transform">
                                    {">"}
                                  </span>
            ...
            <div className="mt-8 space-y-4">
              <p className="key-point">
                <span className="code-comment">{"/* "}</span>
                Strong focus on building scalable solutions and optimizing
                performance
                <span className="code-comment">{" */"}</span>
              </p>
              <p className="text-gray-300">
                <span className="code-comment">{"/* "}</span>
                Passionate about implementing best practices and mentoring team
                members
                <span className="code-comment">{" */"}</span>
              </p>
              <p className="text-gray-300">
              ...
              <div className="pl-4 mt-4 grid gap-4">
                <div className="terminal-card p-4 border border-green-400 rounded-md">
                  ...
                  <p className="mt-2 text-gray-300 pl-9">
                    Significantly improved application performance through
